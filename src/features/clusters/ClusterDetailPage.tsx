                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>
                        ...
                        momentum this topic has. Higher scores mean more
                        trending.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                  ...
                  <>
                    <InfoNote variant="info" className="mb-4">
                      ...
                      <ul className="list-disc list-inside mt-2 space-y-1 text-xs">
                        ...
                        <li>
                          <strong>Sentiment:</strong> Average emotional tone (-1
                          negative to +1 positive) with momentum trend
                        </li>
                        <li>
                    ...
                    <Tabs defaultValue="mentions" className="w-full">
                      ...
                      <TabsContent value="sentiment" className="mt-4">
                        <InfoNote variant="tip" className="mb-4">
                          <p>
                            ...
                            positive). The momentum line (dashed) shows the rate
                            of change—positive momentum indicates improving
                            sentiment, negative momentum suggests declining
                            sentiment.
                          </p>
                        </InfoNote>
                        <div className="mb-2 text-xs text-muted-foreground">
                      ...
                      <TabsContent value="forecast" className="mt-4">
                        <InfoNote variant="tip" className="mb-4">
                          <p>
                            <strong>Forecast Interpretation:</strong> The shaded
                            area represents the predicted range of mentions with
                            confidence intervals. When actual mentions (orange
                            line) fall outside this range, it indicates
                  ...
                  <div className="space-y-4">
                    <InfoNote variant="info" className="mb-3">
                      <p>
                        ...
                        from documents in this cluster and ranked by importance.
                        Larger, bolder keywords have higher weights and are more
                        central to this topic. The visual size represents
                        importance.
                      </p>
                    </InfoNote>
                  ...
                  <>
                    <InfoNote variant="tip" className="mb-4">
                      <p>
                        ...
                        this cluster's documents. Confidence scores indicate how
                        certain the AI model is about each insight.
                      </p>
                    </InfoNote>
